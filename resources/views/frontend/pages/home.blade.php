                                 ...
                                 <div class="col-md-4 mt-2">
                                     <div class="post-media">
                                         <a href="{{ route('posts.show', ['slug' => $blog->slug]) }}" title="">
                                             ...
                                             <img src="{{ asset('storage/banner/' . $item['filename'] . '.' . $item['extension']) }}" alt="" class="img-fluid">
                                             @empty
                         ...
                         <div class="widget">
                             ...
                             <form action="{{ route('home') }}" method="get" class="form-inline search-form">
                                 <div class="form-group">
                                     <input type="text" value="{{ request('q') }}" id="form1" name="q" class="form-control" placeholder="Search Blog Title">
                                 </div>
